...
{
    public partial class Screen11Thunot : UserControl
    {
        public event NextScreenDelegate NextScreen;
        private ArrayList oArrayListTest = new ArrayList();
        // Guy: private string sXmlPath = "xml/Sheelon.xml"; //"C:\\Users\\Lior\\documents\\visual studio 2010\\Projects\\Experiment\\Experiment\\xml\\Sheelon.xml";
        private string sXmlPath = "xml/Thunot.xml"; // \\Experiment\\Experiment\\xml\\Thunot.xml";
        ...
        private void LoadData()
        {
            try
            {
                ...
                label1.Text = Texts.GetScreenText(12, 0);
            ...
            try
            {
                ...
                for (int i = 0; i < oArrayListTest.Count; i++)
                {
                    try
                    {
                        ...
                        //oLabel3.Text = Texts.GetScreenText(12, 3);
                        ...
                        oTable.Controls.Add(oLabel1, 0, 0);
                        oTable.Controls.Add(oLabel2, 6, 0);
                        //oTable.Controls.Add(oLabel3, 6, 0);
